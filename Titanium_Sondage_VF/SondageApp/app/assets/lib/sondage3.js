...
//// region Connexion au fichier json du questionnaire
	var file = Titanium.Filesystem.getFile("/lib/sondages/Transports.json");    
...
validateBtn.addEventListener('click', function() {
	...
	var fileResS3 = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,"ResTransports.json");
	if (!fileResS3.exists) {
		fileResS3.createFile();
	}
	//fileRes.write(JSON.stringify(content));
	var preParseDataS3 = (fileResS3.read().text);
	var contentS3 = JSON.parse(preParseDataS3); 
    ...
    //alert(repUser);
	    ...
	    case 'Tres satisfaisant' :
	        contentS3.rep1[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS3.rep1[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS3.rep1[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS3.rep1[0].choix4 += 1 ;
	        break;
	    default:
	        break;
							}
		...
		switch(repUser[1]) {
	    case 'Tres satisfaisant' :
	        contentS3.rep2[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS3.rep2[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS3.rep2[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS3.rep2[0].choix4 += 1 ;
	        break;
	    default:
	        break;
						}
    	...
    	switch(repUser[2]) {
	    case 'Tres satisfaisant' :
	        contentS3.rep3[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS3.rep3[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS3.rep3[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS3.rep3[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    ...
	    switch(repUser[3]) {
	    case 'Tres satisfaisant' :
	        contentS3.rep4[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS3.rep4[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS3.rep4[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS3.rep4[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    	switch(repUser[4]) {
	    case 'Tres satisfaisant' :
	        contentS3.rep5[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS3.rep5[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS3.rep5[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS3.rep5[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
    
    fileResS3.write(JSON.stringify(contentS3));
    repUser = [0,0,0,0,0];
