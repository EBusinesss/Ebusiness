...
//// region Connexion au fichier json du questionnaire
	var file = Titanium.Filesystem.getFile("/lib/sondages/BU.json");    
...
validateBtn.addEventListener('click', function() {
	...
	var fileResS1 = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,"ResBU.json");
	if (!fileResS1.exists) {
		fileResS1.createFile();
	}
	//fileRes.write(JSON.stringify(content));
	var preParseDataS1 = (fileResS1.read().text);
	var contentS1 = JSON.parse(preParseDataS1); 	
	alert(preParseDataS1);
    ...
    //alert(repUser);
	    ...
	    case 'Tres satisfaisant' :
	        contentS1.rep1[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS1.rep1[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS1.rep1[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS1.rep1[0].choix4 += 1 ;
	        break;
	    default:
	        break;
							}
		...
		switch(repUser[1]) {
	    case 'Tres satisfaisant' :
	        contentS1.rep2[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS1.rep2[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS1.rep2[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS1.rep2[0].choix4 += 1 ;
	        break;
	    default:
	        break;
						}
    	...
    	switch(repUser[2]) {
	    case 'Tres satisfaisant' :
	        contentS1.rep3[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS1.rep3[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS1.rep3[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS1.rep3[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    ...
	    switch(repUser[3]) {
	    case 'Tres satisfaisant' :
	        contentS1.rep4[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS1.rep4[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS1.rep4[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS1.rep4[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    	switch(repUser[4]) {
	    case 'Tres satisfaisant' :
	        contentS1.rep5[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS1.rep5[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS1.rep5[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS1.rep5[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
    
    fileResS1.write(JSON.stringify(contentS1));
    repUser = [0,0,0,0,0];
