...
//// region Connexion au fichier json du questionnaire
	var file = Titanium.Filesystem.getFile("/lib/sondages/Trains.json");    
...
validateBtn.addEventListener('click', function() {
	...
	var fileResS2 = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,"ResTrains.json");
	if (!fileResS2.exists) {
		fileResS2.createFile();
	}

	var preParseDataS2 = (fileResS2.read().text);
	var contentS2 = JSON.parse(preParseDataS2); 
    ...
    //alert(repUser);
	    ...
	    case 'Tres satisfaisant' :
	        contentS2.rep1[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS2.rep1[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS2.rep1[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS2.rep1[0].choix4 += 1 ;
	        break;
	    default:
	        break;
							}
		...
		switch(repUser[1]) {
	    case 'Tres satisfaisant' :
	        contentS2.rep2[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS2.rep2[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS2.rep2[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS2.rep2[0].choix4 += 1 ;
	        break;
	    default:
	        break;
						}
    	...
    	switch(repUser[2]) {
	    case 'Tres satisfaisant' :
	        contentS2.rep3[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS2.rep3[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS2.rep3[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS2.rep3[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    ...
	    switch(repUser[3]) {
	    case 'Tres satisfaisant' :
	        contentS2.rep4[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS2.rep4[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS2.rep4[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS2.rep4[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    	switch(repUser[4]) {
	    case 'Tres satisfaisant' :
	        contentS2.rep5[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS2.rep5[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS2.rep5[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS2.rep5[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
    
    fileResS2.write(JSON.stringify(contentS2));
    repUser = [0,0,0,0,0];
});
