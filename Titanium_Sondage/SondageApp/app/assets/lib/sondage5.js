...
validateBtn.addEventListener('click', function() {
	...
	var fileResS5 = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,"ResWindows.json");
	if (!fileResS5.exists) {
		fileResS5.createFile();
	}
	//fileRes.write(JSON.stringify(content));
	var preParseDataS5 = (fileResS5.read().text);
	var contentS5 = JSON.parse(preParseDataS5); 	
    ...
    //alert(repUser);
	    ...
	    case 'Tres satisfaisant' :
	        contentS5.rep1[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS5.rep1[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS5.rep1[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS5.rep1[0].choix4 += 1 ;
	        break;
	    default:
	        break;
							}
		...
		switch(repUser[1]) {
	    case 'Tres satisfaisant' :
	        contentS5.rep2[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS5.rep2[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS5.rep2[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS5.rep2[0].choix4 += 1 ;
	        break;
	    default:
	        break;
						}
    	...
    	switch(repUser[2]) {
	    case 'Tres satisfaisant' :
	        contentS5.rep3[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS5.rep3[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS5.rep3[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS5.rep3[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    ...
	    switch(repUser[3]) {
	    case 'Tres satisfaisant' :
	        contentS5.rep4[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS5.rep4[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS5.rep4[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS5.rep4[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    	switch(repUser[4]) {
	    case 'Tres satisfaisant' :
	        contentS5.rep5[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS5.rep5[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS5.rep5[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS5.rep5[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
    
    fileResS5.write(JSON.stringify(contentS5));
    repUser = [0,0,0,0,0];
});
