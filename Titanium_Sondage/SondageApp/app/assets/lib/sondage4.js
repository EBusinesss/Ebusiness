...
//// region Connexion au fichier json du questionnaire
	var file = Titanium.Filesystem.getFile("/lib/sondages/Titanium.json");    
...
validateBtn.addEventListener('click', function() {
	...
	var fileResS4 = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,"ResTitanium.json");
	if (!fileResS4.exists) {
		fileResS4.createFile();
	}
	//fileRes.write(JSON.stringify(content));
	var preParseDataS4 = (fileResS4.read().text);
	var contentS4 = JSON.parse(preParseDataS4); 	
    ...
    //alert(repUser);
	    ...
	    case 'Tres satisfaisant' :
	        contentS4.rep1[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS4.rep1[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS4.rep1[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS4.rep1[0].choix4 += 1 ;
	        break;
	    default:
	        break;
							}
		...
		switch(repUser[1]) {
	    case 'Tres satisfaisant' :
	        contentS4.rep2[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS4.rep2[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS4.rep2[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS4.rep2[0].choix4 += 1 ;
	        break;
	    default:
	        break;
						}
    	...
    	switch(repUser[2]) {
	    case 'Tres satisfaisant' :
	        contentS4.rep3[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS4.rep3[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS4.rep3[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS4.rep3[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    ...
	    switch(repUser[3]) {
	    case 'Tres satisfaisant' :
	        contentS4.rep4[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS4.rep4[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS4.rep4[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS4.rep4[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
	    	switch(repUser[4]) {
	    case 'Tres satisfaisant' :
	        contentS4.rep5[0].choix1 += 1 ;
	        break;
	    case 'Satisfaisant' :
	        contentS4.rep5[0].choix2 += 1 ;
	        break;
	    case 'Peu satisfaisant' :
	        contentS4.rep5[0].choix3 += 1 ;
	        break;
	    case 'Insatisfaisant' :
	        contentS4.rep5[0].choix4 += 1 ;
	        break;
	    default:
	        break;}
    
    fileResS4.write(JSON.stringify(contentS4));
    repUser = [0,0,0,0,0];
